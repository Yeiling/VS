...
function LoadExportApiWordBtn() {
    ...
    var btnExport = "<div class='selectBox' style='position: absolute;margin: 0;padding: 0;margin-left: 1432px;top: 2.5px;'>" +
        ...
        "<li>" +
        "<a href='javascript:void(0);' onclick='ExportApiWordExt(1)'>导出 Word</a>" +
        "</li>" +
        "<li>" +
        "<a href='javascript:void(0);' onclick='ExportApiWordExt(2)'>导出 PDF</a>" +
        "</li>" +
        "<li>" +
        "<a href='javascript:void(0);' onclick='ExportApiWordExt(3)'>导出 Html</a>" +
        "</li >" +
        "<li>" +
        "<a href='javascript:void(0);' onclick='ExportApiWordExt(4)'>导出 Xml</a>" +
        "</li >" +
        "<li>" +
        "<a href='javascript:void(0);' onclick='ExportApiWordExt(5)'>导出 Svg</a>" +
        "</li >" +
        "</ul >" +
        "</div >" +
        "</div >";
...
function ExportApiWord(type) {
    ...
    var url = '/Swagger/ExportApiWord?type=' + exten + "&version=" + version;
...
function ExportApiWordExt(type) {
    switch (type) {
        case 1:
            exten = ".docx";
            break;
    ...
    var version = $("#select option:selected").val();
    version = version.split('/')[2];
    var url = "/Swagger/ExportApiWord";
    //var url = '/Swagger/ExportApiWord?type=' + exten + "&version=" + version;
    $.get('/Swagger/ExportApiWord?type=' + exten + "&version=" + version, function (data) {
        var reader = new FileReader();
